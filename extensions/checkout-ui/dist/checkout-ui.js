...
${errorInfo.componentStack}`);
  ...
  // extensions/checkout-ui/utils/hasOfferInCart.js
  var hasOfferInCart = (lines, product) => {
    const cartLineProductVariantIds = lines.map((item) => item.merchandise.id);
    const isProductVariantInCart = product == null ? void 0 : product.variants.nodes.some(
      ({ id }) => cartLineProductVariantIds.includes(id)
    );
    return product;
  };
  var hasOfferInCart_default = hasOfferInCart;

  // extensions/checkout-ui/components/LoadingSkeleton.js
  ...
  var LoadingSkeleton_default = LoadingSkeleton;

  // extensions/checkout-ui/components/ErrorBanner.js
  var import_react21 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var ErrorBanner = () => {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Banner2, { status: "critical", children: "There was an issue adding this product. Please try again." });
  };
  var ErrorBanner_default = ErrorBanner;

  // extensions/checkout-ui/components/ProductOffer.js
  ...
  var ProductOffer = ({
    ...
    const imageUrl = (_a = images.nodes[0]) == null ? void 0 : _a.url;
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(BlockStack2, { spacing: "loose", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Divider2, {}),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { level: 2, children: "You might also like" }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockStack2, { spacing: "loose", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
        InlineLayout2,
        {
          spacing: "base",
          columns: [64, "fill", "auto"],
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(BlockStack2, { spacing: "none", children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { size: "medium", emphasis: "strong", children: title }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { appearance: "subdued", children: renderPrice })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              Button2,
              {
      ...
      showError && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ErrorBanner_default, {})
    ] });
  };
  var ProductOffer_default = ProductOffer;

  // extensions/checkout-ui/gql/getMetaobject.js
  var GET_METAOBJECT_QUERY = `
...
`;
  var METAOBJECT_VARIABLES = {
    variables: { id: "gid://shopify/Metaobject/42567565450" }
  };

  // extensions/checkout-ui/gql/getProduct.js
...
query ($id: ID!) {
  ...
  var Checkout_default = reactExtension("purchase.checkout.block.render", () => /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(App, {}));
  function App() {
    const { query, i18n } = useApi();
    const applyCartLinesChange = useApplyCartLinesChange();
    const [product, setProduct] = (0, import_react22.useState)();
    ...
    const fetchProduct = () => __async(this, null, function* () {
      setLoading(true);
      try {
        const metaobject = yield query(GET_METAOBJECT_QUERY, METAOBJECT_VARIABLES);
        const productData = yield query(
          GET_PRODUCT_QUERY,
    ...
    if (loading) {
      return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(LoadingSkeleton_default, {});
    }
    if (!loading && !product) {
      return null;
    }
    const productOnOffer = hasOfferInCart_default(lines, product);
    if (!productOnOffer) {
      return null;
    }
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
      ProductOffer_default,
      {
